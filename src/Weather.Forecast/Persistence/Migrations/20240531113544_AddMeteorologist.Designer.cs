...
namespace Weather.Forecast.Persistence.Migrations
{
    ...
    [Migration("20240531113544_AddMeteorologist")]
    partial class AddMeteorologist
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Weather.Forecast.Features.Meteorologists.Domain.Meteorologist", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("BirthDay", "Weather.Forecast.Features.Meteorologists.Domain.Meteorologist.BirthDay#BirthDate", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Name", "Weather.Forecast.Features.Meteorologists.Domain.Meteorologist.Name#Name", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Weather.Forecast.Features.Forecasts.Domain.WeatherForecast", b =>
                {
                    b.HasOne("Weather.Forecast.Features.Meteorologists.Domain.Meteorologist", null)
                        .WithMany()
